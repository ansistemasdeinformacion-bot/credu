    ...
    try:
        ...
        for idx, row in df.iterrows():
            try:
                ...
                if not cedula or cedula == 'nan' or cedula == 'None':
                    errores += 1
                    continue
                ...
                if not correo or correo == 'nan' or correo == 'None' or '@' not in correo:
                    errores += 1
                    continue
                    
                contraseña = str(row['CONTRASEÑA']).strip()
                if not contraseña or contraseña == 'nan' or contraseña == 'None':
